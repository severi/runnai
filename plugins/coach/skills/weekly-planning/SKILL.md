...
**Missed an easy run?**
-> Skip it. Don't add volume to other days. Weekly total will be slightly lower, that's fine.

**Missed a quality session?**
-> Can you do it tomorrow? If so, shift the week.
-> If >2 days late, skip it. Don't double up quality sessions.
-> Never do the missed quality AND the next scheduled quality on consecutive days.

**Missed the long run?**
-> Can you do it the next day? Swap with Monday's easy run.
-> If you miss the weekend entirely, do a medium-long run mid-week.
-> Don't add the missed long run distance to next week's long run.

**Missed multiple days (illness/travel)?**
-> 1-3 days missed: resume where you left off, skip missed workouts
-> 4-7 days missed: repeat the previous week at 80% volume
-> 7+ days missed: step back two weeks in the plan
...
If 2+ indicators present: reduce next week's volume by 20-30%.
If 3+ indicators present: take an unplanned recovery week.
