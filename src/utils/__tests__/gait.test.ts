...
// Verified on activity 90000000004: running median 83 per-leg (=166 true),
...
describe("computeMovementBreakdown", () => {
  ...
  test("small run-only drift (<5%) with more walking → still walking, not mixed", () => {
    // Real-world nuance (activity 90000000004): run-only pace drifted ~3% (17s/km
...
// The Aug 2 2026 failure (activity 90000000003, 14.6km, zero walking): the
